Setting.create!([
  ...
  {namespace: "take_photo", value: {"value"=>false}},
  ...
  {namespace: "send_invoice_mail_text", value: {"value"=>"Text example"}},
  {namespace: "send_document_mail_text", value: {"value"=>"Text example"}}
])

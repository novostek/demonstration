...
class Client < ApplicationRecord
    ...
    Apartment::Tenant.switch(self.tenant_name) do
      ...
      begin
        ...
        ProfileUser.create(user_id: user.id, profile_id: profile_admin.id)
          ...
          #defautl documents
        Document.create(name: I18n.t('texts.client.material_delivery'),doc_type: :estimate,sub_type: :conclusion, description: I18n.t('texts.client.template_for_material_receipt_document'), data: "<p></p><table style=\"box-sizing: inherit; border: none; width: 1280px; display: table; border-collapse: collapse; border-spacing: 0px; empty-cells: show; max-width: 100%; color: rgb(65, 65, 65); font-family: sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial; background-color: rgb(255, 255, 255); margin-right: calc(4%);\"><tbody style=\"box-sizing: inherit;\"><tr style=\"box-sizing: inherit; border-bottom: 1px solid rgba(0, 0, 0, 0.12); user-select: none;\"><td colspan=\"2\" style=\"box-sizing: inherit; border: 1px solid rgb(221, 221, 221); padding: 15px 5px; display: table-cell; text-align: left; vertical-align: middle; border-radius: 2px; user-select: text; min-width: 5px; width: 99.9124%;\"><div style=\"box-sizing: inherit; text-align: center;\"><span style=\"box-sizing: inherit; font-size: 36px;\">#{I18n.t('texts.client.material_delivery').upcase}</span></div></td></tr><tr style=\"box-sizing: inherit; border-bottom: 1px solid rgba(0, 0, 0, 0.12); user-select: none;\"><td style=\"box-sizing: inherit; border: 1px solid rgb(221, 221, 221); padding: 15px 5px; display: table-cell; text-align: left; vertical-align: middle; border-radius: 2px; user-select: text; min-width: 5px; width: 52.1673%;\"><p style=\"box-sizing: inherit; font-family: Muli, sans-serif; line-height: 1;\">{{customer.name}}</p><p style=\"box-sizing: inherit; font-family: Muli, sans-serif; line-height: 1;\">{{estimate.location}}</p></td><td style=\"box-sizing: inherit; border: 1px solid rgb(221, 221, 221); padding: 15px 5px; display: table-cell; text-align: left; vertical-align: top; border-radius: 2px; user-select: text; min-width: 5px; width: 47.7451%;\"><span style=\"box-sizing: inherit; font-size: 18px;\">#{I18n.t'texts.client.order_number'}: {{order.code}}</span><br style=\"box-sizing: inherit;\"><br style=\"box-sizing: inherit;\"><span style=\"box-sizing: inherit; color: rgb(65, 65, 65); font-family: sans-serif; font-size: 18px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;\">#{I18n.t'texts.date'}: {{order.start_at}}</span></td></tr></tbody></table><p data-f-id=\"pbf\" style=\"text-align: center; font-size: 14px; margin-top: 30px; opacity: 0.65; font-family: sans-serif;\">#{I18n.t'texts.layout.powered_by'} <a href=\"https://www.froala.com/wysiwyg-editor?pb=1\" title=\"Froala Editor\">Froala Editor</a></p>")
        Document.create(name: I18n.t('texts.client.finish_order'),doc_type: :estimate,sub_type: :conclusion, description: I18n.t('texts.client.template_for_finish_order'), data: "<p style=\"line-height: 115%;text-align: center;background: transparent;font-family: Calibri, serif;font-size:15px;margin-bottom: 0cm;\"></p><p style=\"line-height: 115%;text-align: center;background: transparent;font-family: Calibri, serif;font-size:15px;margin-bottom: 0cm;\"><br></p><p style=\"line-height: 115%;text-align: center;background: transparent;font-family: Calibri, serif;font-size:15px;margin-bottom: 0cm;\"><u><strong>#{I18n.t 'texts.client.job_completion'}</strong></u></p><p style='margin-bottom: 0cm;line-height: 115%;text-align: left;background: transparent;font-family: \"Calibri\", serif;font-size:15px;'><br></p><p style='margin-bottom: 0cm;line-height: 115%;text-align: left;background: transparent;font-family: \"Calibri\", serif;font-size:15px;'>#{I18n.t 'texts.client.i'} {{customer.name}}, #{I18n.t 'texts.client.attest_completed_the_job'} # {{order.code}} #{I18n.t 'texts.client.to_my_satisfaction'}</p><p style='margin-bottom: 0cm;line-height: 115%;text-align: left;background: transparent;font-family: \"Calibri\", serif;font-size:15px;'><br></p><p style='margin-bottom: 0cm;line-height: 115%;text-align: left;background: transparent;font-family: \"Calibri\", serif;font-size:15px;'>#{I18n.t 'texts.client.warranty_on_installation'}</p><p style='margin-bottom: 0cm;line-height: 115%;text-align: left;background: transparent;font-family: \"Calibri\", serif;font-size:15px;'><br></p><p style='margin-bottom: 0cm;line-height: 115%;text-align: left;background: transparent;font-family: \"Calibri\", serif;font-size:15px;'><br>{{order.end_at}}</p><p data-f-id=\"pbf\" style=\"text-align: center; font-size: 14px; margin-top: 30px; opacity: 0.65; font-family: sans-serif;\">#{I18n.t 'texts.layout.powered_by'} <a href=\"https://www.froala.com/wysiwyg-editor?pb=1\" title=\"Froala Editor\">Froala Editor</a></p>")

        costs = TransactionCategory.create!(name: I18n.t('texts.client.costs'), description: I18n.t('texts.client.category_associate_our_costs_transactions'), color: '#e57b95')
        labor = TransactionCategory.create!(name: I18n.t('texts.client.labor'), description: I18n.t('texts.client.category_associate_our_costs_transactions'), color: '#0f34ff')
        payment = TransactionCategory.create!(name: I18n.t('texts.payment'), description: I18n.t('texts.client.category_associate_our_costs_transactions'), color: '#15a24e')
        square = TransactionCategory.create!(name: I18n.t('texts.client.square'), description: I18n.t('texts.client.category_associate_our_costs_transactions'), color: '#49a4d5')

        account = TransactionAccount.create!(name: I18n.t('texts.client.checking_account'), description: I18n.t('texts.client.account_for_checking'), color: '#0b56ad')
        ...
        square_feet = CalculationFormula.create(
          name: I18n.t('texts.client.square_feet'),
          description: I18n.t('texts.client.calculate_quantity_based_square_feet'),
          formula: 'roundup(area / area_covered)'
        )

        square_feet_waste = CalculationFormula.create(
          name: I18n.t('texts.client.square_feet_10_of_waste'),
          description: I18n.t('texts.client.calculate_based_square_feet_10_of_waste'),
          formula: 'roundup((area / area_covered) *1.1)'
        )

        linear_width_square_feet = CalculationFormula.create(
          name: I18n.t('texts.client.linear_width'),
          description: I18n.t('texts.client.calculate_based_linear_width_10_of_waste'),
          formula: 'roundup(width / area_covered)'
        )

        linear_width_square_feet_waste = CalculationFormula.create(
          name: I18n.t('texts.client.calculate_based_linear_width_10_of_waste'),
          description: I18n.t('texts.client.calculate_based_linear_width_10_of_waste'),
          formula: 'roundup((width / area_covered)*1.1)'
        )

        linear_length_square_feet = CalculationFormula.create(
          name: I18n.t('texts.client.linear_length'),
          description: I18n.t('texts.client.calculate_based_linear_length_10_of_waste'),
          formula: 'roundup(length / area_covered)'
        )

        linear_length_square_feet_waste = CalculationFormula.create(
          name: I18n.t('texts.client.linear_length_10_of_waste'),
          description: I18n.t('texts.client.calculate_based_linear_length_10_of_waste'),
          formula: 'roundup((length / area_covered)*1.1)'
        )

        linear_height_square_feet = CalculationFormula.create(
          name: I18n.t('texts.client.linear_height'),
          description: I18n.t('texts.client.calculate_based_linear_height_10_of_waste'),
          formula: 'roundup(height / area_covered)'
        )

        linear_height_square_feet_waste = CalculationFormula.create(
          name: I18n.t('texts.client.linear_height_10_of_waste'),
          description: I18n.t('texts.client.calculate_based_linear_height_10_of_waste'),
          formula: 'roundup((height / area_covered)*1.1)'
        )

        cubic_feet = CalculationFormula.create(
          name: I18n.t('texts.client.cubic_feet'),
          description: I18n.t('texts.client.calculate_based_cubic_feet_10_of_waste'),
          formula: 'roundup((width*length*height) / area_covered)'
        )

        cubic_feet_waste = CalculationFormula.create(
          name: I18n.t('texts.client.cubic_feet_10_of_waste'),
          description: I18n.t('texts.client.calculate_based_cubic_feet_10_of_waste'),
          formula: 'roundup(((width*length*height) / area_covered)*1.1)'
        )

        unitary_value = CalculationFormula.create(
          name: I18n.t('texts.client.default_unitary_value_formula'),
          namespace: 'default-formula',
          description: I18n.t('texts.client.default_unitary_value_formula'),
          formula: '1'
        )
      rescue
      end
  ...
  def self.init_onboard
    ...
    cal_formula = CalculationFormula.find_or_create_by name: I18n.t('texts.client.default_unitary_value_formula'), namespace: 'default-formula', formula: '1', description: I18n.t('texts.client.default_unitary_value_formula')

...
class Estimate < ApplicationRecord
  ...
  def get_subtotal
    self.product_estimates.sum(:value).to_f
  end
  ...
  def calculate_tax_values_for_customer
    ...
    sub_total = self.product_estimates.joins(:product).sum(:value)
    ...
    self.price = sub_total + sub_total_taxes - self.product_estimates.sum(:discount)

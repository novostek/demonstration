...
class SignaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post signatures_url, params: { signature: { file: @signature.file, origin: @signature.origin, origin_id: @signature.origin_id } }
    end
  ...
  test "should update signature" do
    patch signature_url(@signature), params: { signature: { file: @signature.file, origin: @signature.origin, origin_id: @signature.origin_id } }

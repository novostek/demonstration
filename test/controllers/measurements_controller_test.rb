...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { height: @measurement.height, length: @measurement.length, measurement_area_id: @measurement.measurement_area_id, width: @measurement.width } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { height: @measurement.height, length: @measurement.length, measurement_area_id: @measurement.measurement_area_id, width: @measurement.width } }
